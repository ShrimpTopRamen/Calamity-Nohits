...
var bossesData = [
  //King Slime
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Diamond_Staff.png",
            itemName: "Diamond Staff",
          },
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Plasma_Rod.png",
            itemName: "Plasma Rod",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            cssClass: "accessories",
            imageUrl: "../accessories/final/Cleansing_Jelly.png",
            itemName: "Cleansing Jelly (Mana Jelly)",
          },
          {
            cssClass: "accessories",
    ...
    videoSrc:
      "https://www.youtube.com/embed/zdnORlKG86U?si=1f4HoCFKWOTr-3qZ&amp;start=132",
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Waywasher.png",
            itemName: "Waywasher",
          },
        ],
      },
      {
        ...
        items: [
          {
            cssClass: "accessories",
            imageUrl: "../accessories/final/Band_of_Starpower.png",
            itemName: "Band of Starpower",
          },
          {
            cssClass: "accessories",
            imageUrl: "../accessories/final/Sandstorm_in_a_Bottle.png",
  ...
  //EoC
  {
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/Ed54iR7VmyU?si=bkzLZrZFJmlm_Ry5&amp;start=181",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.1.003",
    terrariaVersion: "Terraria Version: 1.4.3.6",
  ...
  //Crabulon
  {
    ...
    categories: [
      {
        ...
        items: [
          {
            cssClass: "head",
            imageUrl: "../armor/final/Victide_Hermit_Helmet.png",
            itemName: "Victide Hermit Helmet",
          },
          {
            cssClass: "chest",
      ...
      },
      {
        ...
        items: [
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Aquamarine_Staff.png",
            itemName: "Aquamarine Staff",
          },
        ],
      },
      {
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/rqDe5ZGxim8?si=jExotnA1Py3d9-1e&amp;start=150",
    videoCaption: "YouTube Video",
  ...
  //BoC
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Frost_Bolt.png",
            itemName: "Frost Bolt",
          },
        ],
      },
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/OAkGWFYKuM4?si=sUSzMNrI_9XyTG5P&amp;start=184",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.1.3",
    terrariaVersion: "Terraria Version: 1.4.3.6",
  ...
  //Perf
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Space_Gun.png",
            itemName: "Space Gun",
          },
        ],
      },
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/FaSdJQY0crA?si=BEyDMNWjneK3EtWj&amp;start=211",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.1.5",
    terrariaVersion: "Terraria Version: 1.4.3.6",
  ...
  //Brimmy
  {
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/dQDP1P3A0gs?si=jvfB88CWbugTdzN3&amp;start=303",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.2.3",
    terrariaVersion: "Terraria Version: 1.4.3.6",
  ...
  //Golem
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Tears_of_Heaven.png",
            itemName: "Tears of Heaven",
          },
          {
            cssClass: "weapons",
            imageUrl: "../weapons/final/Cryophobia.png",
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/y6PbQwnOfGY?si=hPGtgiXxw2WC7i0n&amp;start=211",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.2.3",
    terrariaVersion: "Terraria Version: 1.4.3.6",
    timeTaken: "Time Taken: 0:38",
  ...
  //Plague
  {
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/r5v44bKYuvo?si=v-rEbFgGWlKUhMbD&amp;start=283",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.2.3",
    terrariaVersion: "Terraria Version: 1.4.3.6",
    timeTaken: "Time Taken: 2:23",
  ...
  //AstrumDeus
  {
    ...
    categories: [
      {
        ...
        items: [
          {
            cssClass: "head",
            imageUrl: "../armor/final/Hydrothermic_Mask.png",
            itemName: "Hydrothermic Mask",
          },
          {
            cssClass: "chest",
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/d14DmYmslCc?si=tBQZmjF0exBNWPsX&amp;start=303",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.2.3",
    terrariaVersion: "Terraria Version: 1.4.3.6",
  ...
  //Providence
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            cssClass: "weapons-ammo",
            imageUrl: "../accessories/final/Nebula_Mantle.png",
            itemName: "Nebula Mantle",
          },
          {
            cssClass: "accessories",
            imageUrl: "../accessories/final/Asgard's_Valor.png",
    ...
    moreInformationHeader: "More Information",
    videoSrc:
      "https://www.youtube.com/embed/goCcV2qaWr4?si=ER2Tjv9VsTXX92GA&amp;start=373",
    videoCaption: "YouTube Video",
    calamityVersion: "Calamity Version: 2.0.3.9",
    terrariaVersion: "Terraria Version: 1.4.4.9",
    timeTaken: "Time Taken: 4:04",
