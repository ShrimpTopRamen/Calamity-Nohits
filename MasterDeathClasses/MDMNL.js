...
export const AquaticScourge = "0:55";
export const Twins = "1:20";
export const Brimmy = "1:15";
export const SkellPrime = "1:15";
export const CalClone = "1:50";
export const Plantera = "1:10";
export const LeviandAna = "1:35";
export const AstrumAureus = "1:10";
export const Golem = "0:55";
export const Plague = "1:00";
export const EoL = "1:25";
export const Duke = "1:00";
export const Ravager = "1:10";
export const Cultist = "0:55";
